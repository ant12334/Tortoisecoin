...
signature file SHA256SUMS.asc from bitcoin.org and tortoisecoin.org and
compares them.
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    # remove binaries that are known not to be hosted by bitcoin.org
...
def main():
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes tortoisecoin.org lags behind bitcoin.org.)')
    )
