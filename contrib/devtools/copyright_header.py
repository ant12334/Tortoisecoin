...
EXCLUDE = [
    # auto generated:
    'src/qt/tortoisecoinstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"mini Nakamoto",
    r"The Tortoisecoin Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a tortoisecoin source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Tortoisecoin Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The Tortoisecoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Tortoisecoin Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the tortoisecoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Tortoisecoin
