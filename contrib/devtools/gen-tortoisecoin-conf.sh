...
BITCOIND=${BITCOIND:-$BINDIR/tortoisecoind}
...
then
  ...
  echo -e "To safely generate a tortoisecoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi
