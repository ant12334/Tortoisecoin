...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef TORTOISECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define TORTOISECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the tortoisecoin network\n')
    ...
    g.write('#endif // TORTOISECOIN_CHAINPARAMSSEEDS_H\n')
