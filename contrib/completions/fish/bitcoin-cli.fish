...
complete --command tortoisecoin-cli --no-files
...
complete --command tortoisecoin-cli \
...
# Add commands
# Permit command completions after `tortoisecoin-cli help` but not after other commands
complete \
    --command tortoisecoin-cli \
    --no-files \
