...
(define* (make-tortoisecoin-cross-toolchain target
                                       #:key
...
desirable for building Tortoisecoin Core release binaries."
...
;; failure; see https://github.com/tortoisecoin/tortoisecoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-tortoisecoin-cross-toolchain target)))
