...
if(TARGET tortoisecoin-util AND TARGET tortoisecoin-tx AND PYTHON_COMMAND)
  add_test(NAME util_test_runner
    COMMAND ${CMAKE_COMMAND} -E env BITCOINUTIL=$<TARGET_FILE:tortoisecoin-util> BITCOINTX=$<TARGET_FILE:tortoisecoin-tx> ${PYTHON_COMMAND} ${PROJECT_BINARY_DIR}/test/util/test_runner.py
  )
endif()
