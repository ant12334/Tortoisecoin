...
function(add_boost_if_needed)
  ...
  Although only Boost headers are used to build Tortoisecoin Core,
  ...
  if(BUILD_TESTS AND DEFINED VCPKG_TARGET_TRIPLET)
    ...
    if(NOT HAVE_BOOST_INCLUDED_UNIT_TEST_H)
      message(FATAL_ERROR "Building test_tortoisecoin executable requested but boost/test/included/unit_test.hpp header not available.")
    endif()
  endif()
