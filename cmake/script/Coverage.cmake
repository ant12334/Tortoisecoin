...
execute_process(
  COMMAND ${LCOV_COMMAND} --capture --directory src --test-name test_tortoisecoin --output-file test_tortoisecoin.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
...
execute_process(
  COMMAND ${LCOV_FILTER_COMMAND} test_tortoisecoin.info test_tortoisecoin_filtered.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
  COMMAND ${LCOV_COMMAND} --add-tracefile test_tortoisecoin_filtered.info --output-file test_tortoisecoin_filtered.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
  COMMAND ${LCOV_COMMAND} --add-tracefile baseline_filtered.info --add-tracefile test_tortoisecoin_filtered.info --output-file test_tortoisecoin_coverage.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
  COMMAND ${GENHTML_COMMAND} test_tortoisecoin_coverage.info --output-directory test_tortoisecoin.coverage
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCOV_COMMAND} --add-tracefile baseline_filtered.info --add-tracefile test_tortoisecoin_filtered.info --add-tracefile functional_test_filtered.info --output-file total_coverage.info
