...
class WalletGroupTest(TortoisecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Sending 1.4 TTC should pick one 1.0 + one more. For node #1,
        ...
        # 1 min higher, crossing the threshold from non-grouped to grouped.
