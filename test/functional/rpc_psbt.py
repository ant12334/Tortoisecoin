...
class PSBTTest(TortoisecoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 TTC
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 min/vB and 0.1 TTC/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
        res1 = self.nodes[1].walletcreatefundedpsbt(inputs, outputs, 0, {"fee_rate": 10000, "add_inputs": True})
        assert_approx(res1["fee"], 0.055, 0.005)
        res2 = self.nodes[1].walletcreatefundedpsbt(inputs, outputs, 0, {"feeRate": "0.1", "add_inputs": True})
        assert_approx(res2["fee"], 0.055, 0.005)

        self.log.info("Test min fee rate checks with walletcreatefundedpsbt are bypassed, e.g. a fee_rate under 1 min/vB is allowed")
