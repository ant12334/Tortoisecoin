...
class MempoolAcceptanceTest(TortoisecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.mempool_size = 0
        # Also check feerate. 1TTC/kvB fails
        assert_raises_rpc_error(-8, "Fee rates larger than or equal to 1TTC/kvB are not accepted", lambda: self.check_mempool_result(
        ...
        utxo_to_spend = self.wallet.get_utxo(txid=txid_in_block)  # use 0.3 TTC UTXO
