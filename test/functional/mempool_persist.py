...
By default, tortoisecoind will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent tortoisecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
