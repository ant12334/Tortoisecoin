...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 TTC / 1000 vbytes = 0.00002820 TTC
...
def test_watchonly_psbt(self, peer_node, rbf_node, dest_address):
    ...
    # Ensure the payment amount + change can be fully funded using one of the 0.001TTC inputs.
