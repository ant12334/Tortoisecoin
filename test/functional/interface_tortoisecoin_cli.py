...
# The block reward of coinbaseoutput.nValue (50) TTC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 TTC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"tortoisecoin-cli -h\" for help or \"tortoisecoin-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (TTC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (TTC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 TTC) to the default wallet.
