...
"""Verify that starting tortoisecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tortoisecoin with -h for help text")
        ...
        self.log.info("Start tortoisecoin with -version for version information")
        ...
        self.log.info("Start tortoisecoind with -fakearg to make sure it does not start")
