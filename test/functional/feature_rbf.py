...
class ReplaceByFeeTest(TortoisecoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 TTC/kvB <= old feerate 0.00300000 TTC/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 TTC - so this attempt is rejected.
    ...
    def test_replacement_relay_fee(self):
        ...
        # fee conforming to node's `incrementalrelayfee` policy of 1000 min per KB.
