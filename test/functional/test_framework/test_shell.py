...
class TestShell:
    """Wrapper Class for TortoisecoinTestFramework.

    The TestShell class extends the TortoisecoinTestFramework
    ...
    class __TestShell(TortoisecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TortoisecoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # TortoisecoinTestFramework instances are supposed to be constructed with the path
