...
class KeyPoolTest(TortoisecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Using a fee rate (10 min / byte) well above the minimum relay rate
        # creating a 5,000 min transaction with change should not be possible
        ...
        # creating a 10,000 min transaction without change, with a manual input, should still be possible
        ...
        # creating a 10,000 min transaction without change should still be possible
        ...
        # creating a 10,000 min transaction with a manual change address should be possible
