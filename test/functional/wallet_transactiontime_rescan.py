...
class TransactionTimeRescanTest(TortoisecoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine TTC and create transactions
        ...
        # generate some TTC to create transactions and check blockcount
        ...
        # send 10 TTC to user's first watch-only address
        self.log.info('Send 10 TTC to user')
        ...
        # send 5 TTC to our second watch-only address
        self.log.info('Send 5 TTC to user')
        ...
        # send 1 TTC to our third watch-only address
        self.log.info('Send 1 TTC to user')
