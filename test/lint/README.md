...
```sh
DOCKER_BUILDKIT=1 docker build -t tortoisecoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/tortoisecoin -it tortoisecoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/tortoisecoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/tortoisecoin-core/leveldb-subtree.git (branch tortoisecoin-fork)
* for `src/crypto/ctaes`: https://github.com/tortoisecoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/tortoisecoin-core/crc32c-subtree.git (branch tortoisecoin-fork)
* for `src/minisketch`: https://github.com/tortoisecoin-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/tortoisecoin-core/secp256k1.git
```
