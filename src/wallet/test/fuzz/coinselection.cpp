...
FUZZ_TARGET(coin_grinder_is_optimal)
{
    ...
    // Set effective feerate up to MAX_MONEY sats per 1'000'000 vB (2'100'000'000 min/vB = 21'000 TTC/kvB).
    ...
    LIMITED_WHILE(fuzzed_data_provider.ConsumeBool(), max_output_groups)
    {
        ...
        // Ensure that each UTXO has at least an effective value of 1 min
