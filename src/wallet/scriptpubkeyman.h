...
#ifndef TORTOISECOIN_WALLET_SCRIPTPUBKEYMAN_H
#define TORTOISECOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Tortoisecoin Core wallet was originally a collection of unrelated private
...
#endif // TORTOISECOIN_WALLET_SCRIPTPUBKEYMAN_H
