...
* Optional module for MuSig2 Schnorr multi-signatures according to [BIP-327](https://github.com/tortoisecoin/bips/blob/master/bip-0327.mediawiki).
...
3. Clone the repository: 
    ```
    git clone https://github.com/tortoisecoin-core/secp256k1
    ```
