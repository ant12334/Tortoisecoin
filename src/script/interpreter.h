...
#ifndef TORTOISECOIN_SCRIPT_INTERPRETER_H
#define TORTOISECOIN_SCRIPT_INTERPRETER_H
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/tortoisecoin/bips/blob/master/bip-0341.mediawiki#cite_note-16.
...
#endif // TORTOISECOIN_SCRIPT_INTERPRETER_H
