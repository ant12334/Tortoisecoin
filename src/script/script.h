...
#ifndef TORTOISECOIN_SCRIPT_SCRIPT_H
#define TORTOISECOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Tortoisecoin always counted CHECKMULTISIGs
...
#endif // TORTOISECOIN_SCRIPT_SCRIPT_H
