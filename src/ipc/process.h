...
#ifndef TORTOISECOIN_IPC_PROCESS_H
#define TORTOISECOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning tortoisecoin processes and serving requests
...
#endif // TORTOISECOIN_IPC_PROCESS_H
