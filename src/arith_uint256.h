...
#ifndef TORTOISECOIN_ARITH_UINT256_H
#define TORTOISECOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * mini's original implementation used BN_bn2mpi() and BN_mpi2bn().
     * MPI uses the most significant bit of the first byte as sign.
     * Thus 0x1234560000 is compact (0x05123456)
     * and  0xc0de000000 is compact (0x0600c0de)
     *
     * Tortoisecoin only uses this "compact" format for encoding difficulty
...
#endif // TORTOISECOIN_ARITH_UINT256_H
