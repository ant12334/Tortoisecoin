 ...
 *  A CTxDestination is the internal data type encoded in a tortoisecoin address
 */
...
/**
 * Generate a Tortoisecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
