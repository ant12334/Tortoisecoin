...
void IpcSocketTest(const fs::path& datadir)
{
    ...
    //   Address 'unix' path '"/tmp/test_common_Bitcoin Core/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/test_tortoisecoin.sock"' exceeded maximum socket path length
