...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoin.org:65536", "www.bitcoin.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoin.org:0", "www.bitcoin.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoin.org:", "www.bitcoin.org:", 0, false));
}
