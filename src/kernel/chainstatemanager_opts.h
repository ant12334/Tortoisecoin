...
#ifndef TORTOISECOIN_KERNEL_CHAINSTATEMANAGER_OPTS_H
#define TORTOISECOIN_KERNEL_CHAINSTATEMANAGER_OPTS_H
...
#endif // TORTOISECOIN_KERNEL_CHAINSTATEMANAGER_OPTS_H
