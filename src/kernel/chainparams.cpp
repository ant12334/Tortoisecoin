...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << "04ffff001d0104455468652054696d65732030332f4a616e2f32303039204368616e63656c6c6f72206f6e206272696e6b206f66207365636f6e64206261696c6f757420666f722062616e6b73"_hex << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1747371926, 2958035646, 0x1D00FFFF, 1, 100000000 * COIN);
        ...
        //vSeeds.emplace_back("seed.tortoisecoin.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
...
public:
    CTestNet4Params() {
        ...
        const char* testnet4_genesis_msg = "hi";
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.tortoisecoin.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.tortoisecoin.sprovoost.nl.");
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1747334022, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"6e50a12778460421c99230898c0fa9d6f8e555fb537808844daa35ffdb63b295"});
        assert(genesis.hashMerkleRoot == uint256{"1fdc03d05abb22096af59b86d794875270fa60a5c523565ed3d18876f50dd88f"});
