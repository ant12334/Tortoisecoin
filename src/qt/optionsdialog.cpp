      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->tortoisecoinAtStartup->setToolTip(ui->tortoisecoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->tortoisecoinAtStartup->setText(ui->tortoisecoinAtStartup->text().arg(CLIENT_NAME));

    ui->openTortoisecoinConfButton->setToolTip(ui->openTortoisecoinConfButton->toolTip().arg(CLIENT_NAME));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSTTControls);
