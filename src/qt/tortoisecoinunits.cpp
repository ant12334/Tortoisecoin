...
{
    switch (unit) {
    case Unit::TTC: return QString("Bitcoins");
    case Unit::mTTC: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uTTC: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
{
    switch (unit) {
    case BitcoinUnit::TTC: return 0;
    case BitcoinUnit::mTTC: return 1;
    case BitcoinUnit::uTTC: return 2;
...
{
    switch (num) {
    case 0: return BitcoinUnit::TTC;
    case 1: return BitcoinUnit::mTTC;
    case 2: return BitcoinUnit::uTTC;
