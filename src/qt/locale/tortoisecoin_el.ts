...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Αυτές είναι οι Tortoisecoin διευθύνσεις σας για να στέλνετε πληρωμές. Να ελέγχετε πάντα το ποσό, καθώς και τη διεύθυνση παραλήπτη πριν στείλετε νομίσματα.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Αυτές είναι οι Tortoisecoin διευθύνσεις για τη λήψη πληρωμών. Χρησιμοποιήστε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για τη δημιουργία νέας διεύθυνσης.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Προσοχή! Εάν κρυπτογραφήσετε το πορτοφόλι σας και χάσετε τη φράση πρόσβασης, θα &lt;b&gt; ΧΑΣΕΤΕ ΟΛΑ ΤΑ TORTOISECOIN ΣΑΣ&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα tortoisecoins σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Εισάγετε μια διεύθυνση Tortoisecoin (π.χ. %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Στείλε νομίσματα σε μια διεύθυνση tortoisecoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ελέγξτε τα μηνύματα για να βεβαιωθείτε ότι υπογράφηκαν με τις καθορισμένες διευθύνσεις Tortoisecoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις tortoisecoin: )</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed Tortoisecoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed Tortoisecoin από το πρόχειρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε ένα tortoisecoin: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για Tortoisecoin εντολές </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση "%1" δεν είναι έγκυρη Tortoisecoin διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ Tortoisecoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η προσπάθεια να δαπανήσετε tortoisecoins που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε το tortoisecoin URI</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Σύνδεση στο δίκτυο Tortoisecoin μέσω διαμεσολαβητή SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Συνδεθείτε στο δίκτυο Tortoisecoin μέσω ενός ξεχωριστού διακομιστή μεσολάβησης SOCKS5 για τις onion υπηρεσίες του Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Οι πληροφορίες που εμφανίζονται μπορεί να είναι ξεπερασμένες. Το πορτοφόλι σας συγχρονίζεται αυτόματα με το δίκτυο Tortoisecoin μετά από μια σύνδεση, αλλά αυτή η διαδικασία δεν έχει ακόμη ολοκληρωθεί.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Δεν είναι δυνατή η εκκίνηση του tortoisecoin: χειριστής click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Το 'tortoisecoin://' δεν είναι έγκυρο URI. Αντ' αυτού χρησιμοποιήστε το 'tortoisecoin:'.</translation>
    </message>
    <message>
...
Εάν λαμβάνετε αυτό το σφάλμα, θα πρέπει να ζητήσετε από τον έμπορο να παρέχει ένα URI συμβατό με το BIP21.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση Tortoisecoin ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου Tortoisecoin.</translation>
    </message>
    <message>
...
Σημείωση: Εφόσον η χρέωση υπολογίζεται ανά byte, ένας ρυθμός χρέωσης των «100 satoshis ανά kvB» για μέγεθος συναλλαγής 500 ψηφιακών bytes (το μισό του 1 kvB) θα απέφερε χρέωση μόλις 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές tortoisecoin από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Δημιουργεί μια συναλλαγή Tortoisecoin με μερική υπογραφή (PSBT) για χρήση με π.χ. ένα πορτοφόλι%1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Παρακαλούμε, ελέγξτε την πρόταση συναλλαγής. Θα παραχθεί μια συναλλαγή Tortoisecoin με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
...
Δεν σηματοδοτεί την Aντικατάσταση-Aπό-Έξοδο, BIP-125.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Προειδοποίηση: Μη έγκυρη διεύθυνση Tortoisecoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση Tortoisecoin που θα σταλεί η πληρωμή</translation>
    </message>
    <message>
        <source>Paste address from clipboard</source>
        <translation type="unfinished">Επικόλληση διεύθυνσης από το βιβλίο διευθύνσεων</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα tortoisecoins από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα μήνυμα που επισυνάφθηκε στο tortoisecoin: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου Tortoisecoin.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Διεύθυνση Tortoisecoin που θα σταλεί το μήνυμα</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation type="unfinished">Επιλογή διεύθυνσης που έχει ήδη χρησιμοποιηθεί</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Υπογράψτε το μήνυμα για να αποδείξετε πως σας ανήκει η συγκεκριμένη διεύθυνση Tortoisecoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
    ...
    <message>
        ...
        <translation type="unfinished">Διεύθυνση Tortoisecoin με την οποία έχει υπογραφεί το μήνυμα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Επαληθεύστε το μήνυμα για να αποδείξετε πως υπογράφθηκε από τη συγκεκριμένη διεύθυνση Tortoisecoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation type="unfinished">Επιβεβαίωση Mηνύματος</translation>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s κατεστραμμένο. Δοκιμάστε να το επισκευάσετε με το εργαλείο πορτοφολιού tortoisecoin-wallet, ή επαναφέρετε κάποιο αντίγραφο ασφαλείας.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Σφάλμα: Η έκδοση του αρχείου dump δεν υποστηρίζεται. Αυτή η έκδοση του tortoisecoin-wallet υποστηρίζει αρχεία dump μόνο της έκδοσης 1. Δόθηκε αρχείο dump έκδοσης %s.</translation>
    </message>
    <message>
