 ...
 */
const std::string UA_NAME("mini");


#include <tortoisecoin-build-info.h>
// The <tortoisecoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/tortoisecoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Tortoisecoin Core copyright is not removed by accident
    if (copyright_devs.find("Tortoisecoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Tortoisecoin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tortoisecoin/tortoisecoin>";
