...
#ifndef TORTOISECOIN_INTERFACES_NODE_H
#define TORTOISECOIN_INTERFACES_NODE_H
...
public:
    ...
    //! Return setting value from <datadir>/settings.json or tortoisecoin.conf.
...
#endif // TORTOISECOIN_INTERFACES_NODE_H
