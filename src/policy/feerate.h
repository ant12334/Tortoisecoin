...
#ifndef TORTOISECOIN_POLICY_FEERATE_H
#define TORTOISECOIN_POLICY_FEERATE_H
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::TTC_KVB) const;
...
#endif // TORTOISECOIN_POLICY_FEERATE_H
