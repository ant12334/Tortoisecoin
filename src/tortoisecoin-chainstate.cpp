...
//
// The tortoisecoin-chainstate executable serves to surface the dependencies required
// by a program wishing to use Tortoisecoin Core's consensus engine as it is right
// now.
//
