...
#include <algorithm>
#include <attributes.h> // Added for Tortoisecoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Tortoisecoin Core
#include <util/string.h> // Added for Tortoisecoin Core
...
// Added for Tortoisecoin Core. Similar to std::runtime_format from C++26.
...
// Added for Tortoisecoin Core. Wrapper for checking format strings at compile time.
