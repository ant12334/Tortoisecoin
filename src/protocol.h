...
#ifndef TORTOISECOIN_PROTOCOL_H
#define TORTOISECOIN_PROTOCOL_H
...
/**
 * Tortoisecoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Tortoisecoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // tortoisecoin-development mailing list. Remember that service bits are just
