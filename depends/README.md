...
Tortoisecoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Tortoisecoin Core

**When configuring Tortoisecoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Tortoisecoin Core:
...
variables will be set when generating the Tortoisecoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
