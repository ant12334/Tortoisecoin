...
```
$ gdb ./build/bin/tortoisecoind
…
(gdb) info probes
Type Provider   Name             Where              Semaphore Object
stap net        inbound_message  0x000000000014419e 0x0000000000d29bd2 /build/bin/tortoisecoind
stap net        outbound_message 0x0000000000107c05 0x0000000000d29bd0 /build/bin/tortoisecoind
stap validation block_connected  0x00000000002fb10c 0x0000000000d29bd8 /build/bin/tortoisecoind
…
```
...
```
$ readelf -n ./build/bin/tortoisecoind | grep NT_STAPSDT -A 4 -B 2
...
```
$ tplist -l ./build/bin/tortoisecoind -v
