...
This document provides guidelines for internationalization of the Tortoisecoin Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `tortoisecoin_en.ts` remains unchanged.
