...
3. CMake variables may be used to configure the build system. See [Autotools to CMake Options Mapping](https://github.com/tortoisecoin-core/tortoisecoin-devwiki/wiki/Autotools-to-CMake-Options-Mapping) for details.
