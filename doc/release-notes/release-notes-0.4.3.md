...
http://luke.dashjr.org/programs/tortoisecoin/files/bitcoind-0.4.3/ (until Gavin uploads to SourceForge)
...
http://gitorious.org/tortoisecoin/bitcoind-stable/archive-tarball/v0.4.3#.tar.gz
