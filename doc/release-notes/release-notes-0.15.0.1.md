Tortoisecoin Core version *0.15.0.1* is now available from:

  <https://tortoisecoin.org/bin/tortoisecoin-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/tortoisecoin-core-0.15.0.1/>
