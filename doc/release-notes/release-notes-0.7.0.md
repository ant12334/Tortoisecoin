...
source-only tarballs/zipballs directly from there:
  https://github.com/tortoisecoin/tortoisecoin/tarball/v0.7.0  # .tar.gz
  https://github.com/tortoisecoin/tortoisecoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the tortoisecoin-qt package:
  sudo apt-get install tortoisecoin-qt
...
Tortoisecoin Improvement Proposals implemented
...
Core tortoisecoin handling and blockchain database
...
* Ensure a changed tortoisecoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for tortoisecoin-qt.exe
* (Windows only): add meta-data to tortoisecoin-qt.exe (e.g. description)
