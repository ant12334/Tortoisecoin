Tortoisecoin Core version 0.14.1 is now available from:

  <https://tortoisecoin.org/bin/tortoisecoin-core-0.14.1/>
...
here:
[reducing-tortoisecoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` tortoisecoin-tx input verification (awemany, jnewbery)
