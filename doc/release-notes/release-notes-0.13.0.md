Tortoisecoin Core version 0.13.0 is now available from:

  <https://tortoisecoin.org/bin/tortoisecoin-core-0.13.0/>
...
compatible peers.
[BIP 152](https://github.com/tortoisecoin/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/tortoisecoin/tortoisecoin/pull/8035/files), [BIP 32](https://github.com/tortoisecoin/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/tortoisecoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/tortoisecoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/tortoisecoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/tortoisecoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of Tortoisecoin Core is expected that
...
Witness)] (https://github.com/tortoisecoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/tortoisecoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/tortoisecoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/tortoisecoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/tortoisecoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/tortoisecoin/tortoisecoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for tortoisecoin-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to tortoisecoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add tortoisecoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: tortoisecoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from tortoisecoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the Tortoisecoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for tortoisecoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [Tortoisecoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of tortoisecoind startup (laanwj)
...
- #7975 `fc23fee` Update tortoisecoin-core GitHub links (MarcoFalke)
