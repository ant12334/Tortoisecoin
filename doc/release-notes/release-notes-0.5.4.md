Tortoisecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tortoisecoin/files/Tortoisecoin/tortoisecoin-0.5.4/
...
Fix Tortoisecoin-Qt notifications under Growl 1.3.
Increase required age of Tortoisecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Tortoisecoin-Qt over it. (Windows)
