Download URL: https://sourceforge.net/projects/tortoisecoin/files/Tortoisecoin/tortoisecoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TTC fee schedule (users still pay 0.01 TTC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #tortoisecoin00 - #tortoisecoin99
