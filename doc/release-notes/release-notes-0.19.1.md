...
Tortoisecoin Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/tortoisecoin-core-0.19.1/>
...
From Tortoisecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Tortoisecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Tortoisecoin Core does not yet change appearance when
...
- #17488 fix "tortoisecoind already running" warnings on macOS (fanquake)
