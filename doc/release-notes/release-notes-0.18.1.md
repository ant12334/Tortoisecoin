Tortoisecoin Core version 0.18.1 is now available from:

  <https://bitcoincore.org/bin/tortoisecoin-core-0.18.1/>
...
`/Applications/Tortoisecoin-Qt` (on Mac) or `bitcoind`/`tortoisecoin-qt` (on
Linux).
...
- #15947 Install tortoisecoin-wallet manpage (domob1812)
