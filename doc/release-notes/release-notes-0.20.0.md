...
Tortoisecoin Core version 0.20.0 is now available from:
  ...
  <https://bitcoin.org/bin/tortoisecoin-core-0.20.0/>
...
- A "known bug" [announced](https://bitcoin.org/en/releases/0.18.0/#wallet-gui)
...
- Tortoisecoin Core's automatically-generated source code documentation is
  now available at https://doxygen.bitcoin.org.  (#17596)
...
- #17596 Change doxygen URL to doxygen.bitcoin.org (laanwj)
