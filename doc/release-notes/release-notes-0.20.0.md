...
Tortoisecoin Core version 0.20.0 is now available from:
  ...
  <https://bitcoincore.org/bin/tortoisecoin-core-0.20.0/>
...
- #17910 Remove double `LIBTORTOISECOIN_SERVER` linking (fanquake)
...
- #18429 Remove double `LIBTORTOISECOIN_SERVER` from bench-Makefile (brakmic)
