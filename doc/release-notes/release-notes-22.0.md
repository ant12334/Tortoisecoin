...
Tortoisecoin Core version 22.0 is now available from:
  ...
  <https://bitcoin.org/bin/tortoisecoin-core-22.0/>
...
- tortoisecoin-core/gui#21 Improve pruning tooltip (fluffypony, BitcoinErrorLog)
...
- tortoisecoin/tortoisecoin#20577 libconsensus: add missing error code description, fix NBitcoin link (theStack)
