Tortoisecoin Core version 0.10.3 is now available from:

  <https://tortoisecoin.org/bin/tortoisecoin-core-0.10.3/>
...
(see https://github.com/tortoisecoin/tortoisecoin/pull/6793, as well as the 0.11.0
