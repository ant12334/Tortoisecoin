Contributing to Tortoisecoin Core
============================

The Tortoisecoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Tortoisecoin Core
...
Before you start contributing, familiarize yourself with the Tortoisecoin Core build
system and tests. Refer to the documentation in the repository on how to build
Tortoisecoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/tortoisecoin/tortoisecoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/tortoisecoin/tortoisecoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
Most communication about Tortoisecoin Core development happens on IRC, in the
`#tortoisecoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#tortoisecoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/tortoisecoin-core-dev/](https://www.erisian.com.au/tortoisecoin-core-dev/)
and [https://gnusha.org/tortoisecoin-core-dev/](https://gnusha.org/tortoisecoin-core-dev/).
...
For GUI-related issues or pull requests, the https://github.com/tortoisecoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/tortoisecoin/tortoisecoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to tortoisecoin-qt
...
fork of Tortoisecoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/tortoisecoin/tortoisecoin/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/tortoisecoin/tortoisecoin  # Fetch the latest upstream commit
...
The following applies to code changes to the Tortoisecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Tortoisecoin
Network Protocol consensus changes.

Whether a pull request is merged into Tortoisecoin Core rests with the project merge
maintainers.
...
Patches that change Tortoisecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tortoisecoin consensus, it must have been
...
https://github.com/tortoisecoin/tortoisecoin/pull/16189).

Also see the [backport.py script](
https://github.com/tortoisecoin-core/tortoisecoin-maintainer-tools#backport).
